...
<html lang="fr">
<head>
  <link rel="alternate" hreflang="fr" href="https://mon-site.com/fr/products" />
  <link rel="alternate" hreflang="en" href="https://mon-site.com/en/products" />
</head>
```
...
test.describe('Internationalisation', () => {
  ...
  test('le formatage des prix respecte la locale', async ({ page }) => {
    ...
    await expect(page.locator('[data-testid="price"]').first())
      .toHaveText(/\d+,\d{2}\s€/)
