...
test.describe("Audit accessibilite", () => {
  test("la page d'accueil ne contient pas de violation a11y", async ({
    page,
  }) => {
    await page.goto("/");
  ...
  <form @submit.prevent="handleSubmit" novalidate>
    <div>
      ...
      <input
        ...
        autocomplete="name"
      />
      <p v-if="nameError" id="name-error" role="alert" class="error">
        {{ nameError }}
      </p>
    </div>
...
→ `exercices/24-audit-accessibilite/ENONCE.md`
